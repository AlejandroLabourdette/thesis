...
\title{Lógica para un Gestor de Certificados Académicos}
\author{\\\vspace{0.25cm}José Alejandro Labourdette - Lartigue Soto}
\advisor{
	\\\vspace{0.25cm}Camilo Denis González
	\\\vspace{0.2cm}Daniel Mena Frías
	\\\vspace{0.2cm}Miguel Katrib Mora}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{Fecha:28/11/22\\\vspace{0.25cm}\href{https://github.com/AlejandroLabourdette/thesis}{github.com/AlejandroLabourdette/thesis}}
